...
{
  public class WebPostViewConfig : EntityTypeConfiguration<WebPostView>
  {
    public WebPostViewConfig()
    {
      ToTable("WebPostView");
      ...
      //Property(r => r.PostId).HasColumnAnnotation(
      //  IndexAnnotation.AnnotationName,
      //  new IndexAnnotation(
      //    new IndexAttribute("IX_PostId", 2) { IsUnique = true }));
