jQuery(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", "#btn-like", function () {
            $("#reactForm #Like").val(true);
            $("#likeForm").submit();
        });

        $(document).on("click", "#btn-unlike", function () {
            $("#reactForm #Like").val(false);
            $("#likeForm").submit();
        });
        ...
        $(document).on("submit", "#likeForm", function (e) {
            ...
            $.ajax({
                ...
                data: $(this).serialize(),
                beforeSend: function () {
                    // loadingFullLoad(".contractResult");
                },
                success: function (data) {
                    ...
                    //loadingFullHide(".contractResult");
                },
                error: function (data) {
                }
            });
...
function submitLoginForm(btn) {
    ...
    if ($("#loginForm").valid()) {
        $.ajax({
            type: "Post",
            url: "/Account/LoginPartial",
            data: $("#loginForm").serialize() + "&returnUrl=" + window.location.href,
            beforeSend: function () {
                $(btn).button("loading");
            },
            success: function (data) {
