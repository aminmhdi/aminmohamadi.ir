...
{
  public class PostRelatedOrRecentListViewModel
    {
    public PostRelatedOrRecentListViewModel()
    {
    ...
    /// </summary>
    public IEnumerable<PostRelatedOrRecentDetailViewModel> Posts { get; set; }
